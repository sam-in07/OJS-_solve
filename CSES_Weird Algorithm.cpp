...
#define on                 string s
#define up                 cin >> s 
#define a(v)               v.begin(), v.end()//v(n)
// I just heard you found the one you've been looking
// You've been looking for
// I wish I would have known that wasn't me
#define mii                map<int,int>v;
#define mci                map<char,int>mp;
...
#define evo                n = s.size();
#define ash                  ll j ,  i,  n , m ,sums , a , b, c, val_stor , val_stor1 , val_stro2 , val_stor3 , count_kor = 0 , k , sum = 0 , x , y, z 
#define gtr                '\n'
